...
/****** Object:  Database [WebApiDb]    Script Date: 10/16/2015 1:49:42 AM ******/
DROP DATABASE [WebApiDb]
GO

/****** Object:  Database [WebApiDb]    Script Date: 10/16/2015 1:49:42 AM ******/
CREATE DATABASE [WebApiDb] ON  PRIMARY 
( NAME = N'WebApiDb', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\WebApiDb.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'WebApiDb_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\WebApiDb_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [WebApiDb] SET COMPATIBILITY_LEVEL = 100
GO
